...
### Account slug en rutas

Los endpoints que requieren una cuenta (especialmente ARCA) usan el slug del account en la ruta:
```
...
<Expandable title="¿Cómo obtengo el account_slug?" default-open="false">
